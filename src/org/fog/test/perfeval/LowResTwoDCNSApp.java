...
public class LowResTwoDCNSApp {
 ...
 ////// Saeedeh added up scenarios
    ...
    private static Application createApplication1(String appId, int userId) {
		 ...
		 * Connecting the application modules (vertices) in the application model (directed graph) with edges
		 */
		application.addAppEdge("CAMERA_1", "motion_detector_1", 500, 10000, "CAMERA_1", Tuple.UP, AppEdge.SENSOR); // adding edge from CAMERA (sensor) to Motion Detector module carrying tuples of type CAMERA
		application.addAppEdge("motion_detector_1", "object_detector_1", 1000, 1000, "MOTION_VIDEO_STREAM_1", Tuple.UP, AppEdge.MODULE); // adding edge from Motion Detector to Object Detector module carrying tuples of type MOTION_VIDEO_STREAM
		application.addAppEdge("object_detector_1", "user_interface_1", 250, 1000, "DETECTED_OBJECT_1", Tuple.UP, AppEdge.MODULE); // adding edge from Object Detector to User Interface module carrying tuples of type DETECTED_OBJECT
